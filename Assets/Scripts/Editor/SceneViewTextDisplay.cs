...
public class SceneViewTextDisplay : MonoBehaviour
{
    ...
    static void DrawSceneGizmos(Transform transform, GizmoType gizmoType)
    {
        ...
        if (SceneView.currentDrawingSceneView != null)
        {
            ...
            GameObject playerGo = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Resources/Prefabs/player.prefab");
            // 显示文本
            ...
            playerGo = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Resources/Prefabs/Plane.prefab");
            // 显示文本
