...
{
    [CreateNodeMenu("Football AI/CheckIsEnemyControllingBall")]
    public class CheckIsEnemyControllingBallGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new CheckIsEnemyControllingBall(blackboard);
        }
    }
}
