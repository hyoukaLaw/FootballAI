...
{
    [CreateNodeMenu("Football AI/CheckHasClearanceTarget")]
    public class CheckHasClearanceTargetGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new CheckHasClearanceTarget(blackboard);
        }
    }
}
