...
{
    [CreateNodeMenu("Football AI/TaskCalculateSupportSpot")]
    public class TaskCalculateSupportSpotGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new TaskCalculateSupportSpot(blackboard);
        }
    }
}
