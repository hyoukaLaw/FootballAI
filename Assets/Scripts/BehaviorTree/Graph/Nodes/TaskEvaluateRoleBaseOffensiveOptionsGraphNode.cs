...
{
    [CreateNodeMenu("Football AI/TaskEvaluateRoleBaseOffensiveOptions")]
    public class TaskEvaluateRoleBaseOffensiveOptionsGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new TaskEvaluateRoleBaseOffensiveOptions(blackboard);
        }
    }
}
