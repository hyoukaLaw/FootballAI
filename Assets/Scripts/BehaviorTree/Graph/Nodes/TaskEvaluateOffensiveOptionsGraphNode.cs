...
{
    [CreateNodeMenu("Football AI/TaskEvaluateOffensiveOptions")]
    public class TaskEvaluateOffensiveOptionsGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new TaskEvaluateOffensiveOptions(blackboard);
        }
    }
}
