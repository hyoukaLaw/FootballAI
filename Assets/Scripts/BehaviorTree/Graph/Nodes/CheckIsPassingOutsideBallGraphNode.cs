...
{
    [CreateNodeMenu("Football AI/CheckIsPassingOutsideBall")]
    public class CheckIsPassingOutsideBallGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new CheckIsPassingOutsideBall(blackboard);
        }
    }
}
