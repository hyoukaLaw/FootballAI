...
{
    [CreateNodeMenu("Football AI/CheckIsClosestToLooseBall")]
    public class CheckIsClosestToLooseBallGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new CheckIsClosestToLooseBall(blackboard);
        }
    }
}