...
{
    [CreateNodeMenu("Football AI/CheckIsTeamControllingBall")]
    public class CheckIsTeamControllingBallGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new CheckIsTeamControllingBall(blackboard);
        }
    }
}