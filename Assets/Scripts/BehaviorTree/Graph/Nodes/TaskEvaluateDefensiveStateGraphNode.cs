...
{
    [CreateNodeMenu("Football AI/TaskEvaluateDefensiveState")]
    public class TaskEvaluateDefensiveStateGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new TaskEvaluateDefensiveState(blackboard);
        }
    }
}
