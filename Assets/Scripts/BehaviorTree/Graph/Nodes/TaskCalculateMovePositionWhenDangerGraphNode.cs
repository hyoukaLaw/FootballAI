...
{
    [CreateNodeMenu("Football AI/TaskCalculateMovePositionWhenDanger")]
    public class TaskCalculateMovePositionWhenDangerGraphNode : BTGraphNode
    {
        ...
        {
            // 构造运行时对象
            return new TaskCalculateMovePositionWhenDanger(blackboard);
        }
    }
}
